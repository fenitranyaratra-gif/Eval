...
const routes = [
  ...
  { path: "/products/inventory", component: ProductInventory },

  { path: "/products/create", component: CreateProductView },
  { path: "/cart", component: () => import("@/views/Panier/CartView.vue") },
  {
    path: "/checkout",
    component: () => import("@/views/Panier/CheckoutView.vue"),
  },
  { path: "/orders", component: () => OrdersView },
  {
    path: "/wishlist",
    component: () => import("@/views/Products/WishlistView.vue"),
  },
  {
    path: "/products/:id",
...
router.beforeEach((to, from) => {
  ...
  if (to.meta.requiresAdmin && !adminAuthService.isLoggedIn()) {
    return "/admin/login"; // ← retourne la route au lieu de next()
  }
